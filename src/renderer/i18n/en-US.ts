...
export const enUS = {
  ...
  servicePage: {
    ...
    miniTime: "Time",
    noStatsData: "No data",
    ruleMiniTrend: "Rule mini trend chart",
  },
  ...
  logs: {
    ...
    statsRulesSelected: "{{count}} rules selected",
    ...
    trendRpm: "RPM",
    trendInputTpm: "Input TPM",
    trendOutputTpm: "Output TPM",
    trendRateLeftAxis: "TPM",
    trendRateRightAxis: "RPM",
    peakRpm: "Peak RPM",
    peakInputTpm: "Peak Input TPM",
    peakOutputTpm: "Peak Output TPM",
  ...
  ruleForm: {
    ...
    quotaLowThresholdHint:
      "Numbers only. Rule card shows low-quota state when remaining is below this value.",
